...
<body>
    ...
    <div class="row">
      ...
      <div class="navLinks">
        <ul class="menuLinks">
          ...
          <li class="subMenuContainer">
            <a class="activeLink" href="login&signin.php">account</a>
          </li>
  ...
  <nav class="mobileNavBar">
    ...
    <div class="mblNavLinks">
      <ul>
        ...
        <li>
          <a class="activeLink" href="login&signin.php">account <i class="fa fa-angle-down"></i></a>
        </li>
        <li>
  ...
  if (isset($_REQUEST['Rsubmit'])) {
    ...
    $connectR = mysqli_connect('localhost', 'root', '', 'Brigate');

    if (!$connectR) {
      die("Sorry server is not connected." . mysqli_error());
    }

    $query = "INSERT INTO reg_info (fname, lname, Rusername, Rpassword) VALUES ('$fname', '$lname', '$Rusername', '$Rpassword')";

    $result = mysqli_query($connectR, $query);
  ...
  if (isset($_REQUEST['Lsubmit'])) {
    ...
    $connectL = mysqli_connect('localhost', 'root', '', 'Brigate');

    if (!$connectL) {
      die("Sorry server is not connected." . mysqli_error());
    }

    $query = "INSERT INTO log_info (Lusername, Lpassword) VALUES ('$Lusername', '$Lpassword')";

    $result = mysqli_query($connectL, $query);
