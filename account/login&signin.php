    ...
    <section class="LoginReg">
        <div class="row">
            <div class="formBox">
                ...
                <hr id="indicator">
                <form action="account.php" method="get" class="regForm">
                    ...
                    <button name="Rsubmit" class="btn btnHover btnForm">registration</button>
                </form>
                <form action="account.php" method="get" class="loginForm">
                    ...
                    <button name="Lsubmit" class="btn btnHover btnForm">login</button>
                </form>
            </div>
        </div>
    </section>
